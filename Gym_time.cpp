...
int back() {
    ...
    if (time_slot == 1) {
        ...
        cout << "The rating for doing back and bicep at 8AM is:  " << final_rating_ts2 << " out of 10" << endl;
    }
    else {
        cout << "Wrong option has been choosen \n Please choose again" << endl;
        back();
...
int chest2() {
    ...
    if (time_slot == 1) {
        ...
        rating_timeslot_1 = (chest_press + inclined_chest_press + flys + pull_down)/(4);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing chest and tricep at 3PM to 4PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else if (time_slot == 2) {
        ...
        rating_timeslot_1 = (chest_press + inclined_chest_press + flys + pull_down)/(4);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing chest and tricep at 4PM to 5PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else if (time_slot == 3) {
        ...
        rating_timeslot_1 = (chest_press + inclined_chest_press + flys + pull_down)/(4);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing chest and tricep at 5PM to 6PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else if (time_slot == 4) {
        ...
        rating_timeslot_1 = (chest_press + inclined_chest_press + flys + pull_down)/(4);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing chest and tricep at 6PM to 7PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else if (time_slot == 5) {
        ...
        rating_timeslot_1 = (chest_press + inclined_chest_press + flys + pull_down)/(4);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing chest and tricep at 7PM to 8PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else {
...
int back2() {
    ...
    if (time_slot == 1) {
        ...
        rating_timeslot_1 = (lat_pulldown + T_bar + bicep_curls + pull_ups + seated_rows)/(5);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing back and bicep at 5PM to 6PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else if (time_slot == 4) {
        ...
        rating_timeslot_1 = (lat_pulldown + T_bar + bicep_curls + pull_ups + seated_rows)/(5);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing back and bicep at 6PM to 7PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else if (time_slot == 5) {
        ...
        rating_timeslot_1 = (lat_pulldown + T_bar + bicep_curls + pull_ups + seated_rows)/(5);
        float final_rating_ts1 = 10 - rating_timeslot_1;
        cout << "The rating for doing back and bicep at 7PM to 8PM is:  " << final_rating_ts1 << " out of 10" << endl;
    }
    else {
        cout << "Wrong option has been choosen \n Please choose again" << endl;
        back2();
